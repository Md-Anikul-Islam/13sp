...
<head>
    <meta charset="utf-8" />
    <title>Log In | 13space Admin</title>
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="auth-brand p-4">
                                    <a href="{{ url('/') }}" class="logo-light">
                                        <img src="{{ asset('backend/images/13space.png') }}" alt="logo" height="100">
                                    </a>
                                    <a href="{{ url('/') }}" class="logo-dark">
                                        <img src="{{ asset('backend/images/13space.png') }}" alt="dark logo" height="100">
                                    </a>
                                </div>
